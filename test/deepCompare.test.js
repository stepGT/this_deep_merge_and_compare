...
describe('Deep Compare test', () => {
  ...
  it('8. Expects same length of arrays is not to be equal', () => {
    expect(deepCompare([1, 2, 4], [1, 2, 3])).to.equal(false);
  });

  it('9. Expects arrays is to be equal', () => {
    expect(deepCompare([1, 2, 3], [1, 2, 3])).to.equal(true);
  });

  it('10. Expects deep arrays is to be equal', () => {
    expect(
      deepCompare(
  ...
  it('11. Expects deep arrays is not to be equal', () => {
    expect(
      deepCompare(
  ...
  it('13. Expects objects is to be equal', () => {
    expect(deepCompare({ a: 1, b: 2, c: 6 }, { a: 1, b: 2, c: 6 })).to.equal(true);
  });
